...
export default function FarmerOrdersScreen() {
  ...
  const renderOrderCard = (order) => {
    ...
    const vendorName = order.vendor?.organizationName || order.vendor?.name || 'Unknown Vendor';
      ...
      <View key={order._id} style={styles.orderCard}>
        ...
        <View style={styles.orderHeader}>
            ...
            <View style={styles.productInfo}>
                <Text style={styles.orderProductName}>{order.productSnapshot.name}</Text>
        ...
        <View style={styles.orderBody}>
            ...
            <View style={styles.detailRow}>
                ...
                <Text style={styles.detailValueAmount}>{formatCurrency(order.totalAmount)}</Text>
            </View>
            
            <View style={styles.detailRow}>
                <Text style={styles.detailLabel}>Quantity</Text>
                <Text style={styles.detailValue}>{order.quantity} {order.productSnapshot.unit}</Text>
            </View>
                ...
                <>
                    ...
                    <View style={styles.detailRow}>
                        ...
                        <Text style={styles.detailValuePeriod}>
                            {new Date(order.rentalDuration.startDate).toLocaleDateString()} - {new Date(order.rentalDuration.endDate).toLocaleDateString()}
                        </Text>
                    </View>
                </>
            )}
      ...
      >
        <View style={styles.container}>
          ...
          <Text style={styles.subtitle}>
            Track the status of your purchases and rentals ({orders.length} total)
          </Text>
          ...
          {orders.length === 0 && !error ? (
             <View style={styles.noOrdersCard}>
              <MaterialCommunityIcons name="clipboard-text-off" size={30} color="#888" />
