...
export default function MyFarmScreen() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const cropsRes = await fetch(`${API_BASE_URL}/api/crops/crops`, {
        headers,
      });
      if (cropsRes.ok) {
        ...
        <View style={styles.fieldTitleRow}>
          <View
            style={[
              ...
              { backgroundColor: field.color || "#2A9D8F" },
            ]}
          />
            ...
            <ScrollView style={styles.modalBody}>
                ...
                >
                  ...
                  >
                    {newField.coordinates && (
                      <Marker
                        coordinate={{
                          latitude: newField.coordinates.lat,
                          longitude: newField.coordinates.lng,
                        }}
                        pinColor="#2A9D8F"
                      />
                    )}
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewField({ ...newField, soilType: text })
                  }
              ...
              >
                <Text style={styles.submitButtonText}>
                  {isSubmitting ? t("Adding...") : t("Add Field")}
                </Text>
              </TouchableOpacity>
        ...
        <View style={styles.fullMapContainer}>
          ...
          <View style={styles.fullMapHeader}>
            ...
            <Text style={styles.fullMapTitle}>
              {tempCoords ? t("Location Set") : t("Pin Field Location")}
            </Text>
          ...
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>
                {t("Select Crop for", { name: selectedField?.name })}
              </Text>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              {crops.map((crop) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.cropOption,
                    selectedCropId === crop._id && styles.cropOptionSelected,
                  ]}
                ...
                >
                  <MaterialCommunityIcons
                    ...
                    size={24}
                    color={selectedCropId === crop._id ? "#FFF" : "#2A9D8F"}
                  />
                  <View style={styles.cropOptionInfo}>
                    ...
                    <Text
                      style={[
                        styles.cropOptionDetails,
                        selectedCropId === crop._id &&
                          styles.cropOptionDetailsSelected,
                      ]}
                    >
                      {crop.season} • {crop.duration} • {crop.waterRequirement}{" "}
                      {t("Water")}
                    </Text>
                  </View>
                  {selectedCropId === crop._id && (
              ...
              <TouchableOpacity
                style={styles.submitButton}
                onPress={handleUpdateFieldCrop}
                disabled={isSubmitting}
              >
                <Text style={styles.submitButtonText}>
                  {isSubmitting ? t("Planting...") : t("Plant Crop")}
                </Text>
              </TouchableOpacity>
              <View style={{ height: 40 }} />
            </ScrollView>
      ...
      <Modal visible={showHarvestModal} animationType="slide" transparent>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>
                {t("Harvest ", { name: selectedField?.cropId?.cropName })}
              </Text>
            ...
            <View style={styles.modalBody}>
              <View style={styles.inputGroup}>
                <Text style={styles.inputLabel}>
                  {t("Quantity Harvested *")}
                </Text>
                <TextInput
                  style={styles.input}
                  value={harvestData.quantity}
                  onChangeText={(text) =>
                    setHarvestData({ ...harvestData, quantity: text })
                  }
                  keyboardType="decimal-pad"
                  placeholder="e.g., 50"
                />
                ...
                <View style={styles.unitRow}>
                  {["kg", "quintal", "ton"].map((unit) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.unitButton,
                        harvestData.unit === unit && styles.unitButtonSelected,
                      ]}
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setHarvestData({ ...harvestData, storageLocation: text })
                  }
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setHarvestData({ ...harvestData, notes: text })
                  }
              ...
              >
                <Text style={styles.submitButtonText}>
                  {isSubmitting ? t("Recording...") : t("Record Harvest")}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
